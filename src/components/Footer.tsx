          ...
          <div className="footer-col">
            {showOrganizadores ? (
              <>
                ...
                <ul className="footer-links">
                  <li><a href="https://www.twitch.tv/tomikka" target="_blank" rel="noopener">Twitch · Tomikka</a></li>
                  <li><a href="https://www.twitch.tv/maticunial" target="_blank" rel="noopener">Twitch · Maticunial</a></li>
                </ul>
              </>
            ) : (
              <>
                ...
                <ul className="footer-links">
                  <li><a href="https://discord.gg/ScF3MV6Ywh" target="_blank" rel="noopener">Discord del campeonato</a></li>
                  <li><a href="https://www.instagram.com/copachapachapa/" target="_blank" rel="noopener">Instagram</a></li>
                </ul>
              </>
            )}
          </div>
