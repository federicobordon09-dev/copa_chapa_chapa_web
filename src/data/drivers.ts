...
const rawDrivers = [
  ...
  { num: "06", initials: "AR", name: "Alejandro Rodriguez", pts: 25, split: "Split 2 Bs Aires", avatarGradient: "linear-gradient(135deg,#27ae60,#1a7a40)" },
  { num: "07", initials: "BK", name: "Bruno Koller", pts: 25, split: "Split 1 Bs Aires", avatarGradient: "linear-gradient(135deg,#1abc9c,#0e8a70)" },
  { num: "08", initials: "MT", name: "Marcos Turri", pts: 23, split: "Split 1 Comodoro", avatarGradient: "linear-gradient(135deg,#e84087,#a01c55)" },
  { num: "09", initials: "AC", name: "Agustin Carreras", pts: 22, split: "Split 2 Bs Aires", avatarGradient: "linear-gradient(135deg,#3498db,#1a6ea0)" },
  { num: "10", initials: "BC", name: "Brian Campos", pts: 22, split: "Split 2 Comodoro", avatarGradient: "linear-gradient(135deg,#e8a040,#c97d10)" },
  { num: "11", initials: "JG", name: "Joaquin Gutierrez", pts: 22, split: "Split 2 Bs Aires", avatarGradient: "linear-gradient(135deg,#e8c240,#a08810)" },
  { num: "12", initials: "MV", name: "Matteo Viñas", pts: 20, split: "Split 1 Bs Aires", avatarGradient: "linear-gradient(135deg,#e86840,#a03010)" },
  ...
  { num: "14", initials: "AR", name: "Agustin Rojas", pts: 18, split: "Split 2 Bs Aires", avatarGradient: "linear-gradient(135deg,#16a085,#0d6655)" },
  { num: "15", initials: "ND", name: "Nacho Davin", pts: 17, split: "Split 1 Comodoro", avatarGradient: "linear-gradient(135deg,#2980b9,#1a5276)" },
  { num: "16", initials: "MP", name: "Matias Pacheco", pts: 16, split: "Split 2 Bs Aires", avatarGradient: "linear-gradient(135deg,#c0392b,#922b21)" },
  { num: "17", initials: "FA", name: "Fernando Ali", pts: 15, split: "Split 2 Comodoro", avatarGradient: "linear-gradient(135deg,#f39c12,#a06000)" },
  { num: "18", initials: "AM", name: "Agustin Moles", pts: 15, split: "Split 2 Bs Aires", avatarGradient: "linear-gradient(135deg,#1abc9c,#148f77)" },
  ...
  { num: "21", initials: "GA", name: "Gonzalo Alonso", pts: 13, split: "Split 1 Bs Aires", avatarGradient: "linear-gradient(135deg,#27ae60,#1e8449)" },
  { num: "22", initials: "UM", name: "Uriel Manzanelli", pts: 13, split: "Split 2 Bs Aires", avatarGradient: "linear-gradient(135deg,#e74c3c,#c0392b)" },
  ...
  { num: "25", initials: "AC", name: "Agustin Chijanoski", pts: 11, split: "Split 1 Bs Aires", avatarGradient: "linear-gradient(135deg,#f1c40f,#d4ac00)" },
  ...
  { num: "28", initials: "MC", name: "Matias Cayrus Riffel", pts: 9, split: "Split 2 Bs Aires", avatarGradient: "linear-gradient(135deg,#8e44ad,#7d3c98)" },
  { num: "29", initials: "NV", name: "Nico Valero", pts: 8, split: "Split 2 Bs Aires", avatarGradient: "linear-gradient(135deg,#2ecc71,#27ae60)" },
  ...
  { num: "32", initials: "EP", name: "Eric Priemer", pts: 5, split: "Split 1 Bs Aires", avatarGradient: "linear-gradient(135deg,#7f8c8d,#626567)" },
  { num: "33", initials: "SO", name: "Santiago Ortiz Ocampo", pts: 3, split: "Split 1 Bs Aires", avatarGradient: "linear-gradient(135deg,#e84040,#922b21)" },
  { num: "34", initials: "LS", name: "Luka Sanchez", pts: 3, split: "Split 2 Comodoro", avatarGradient: "linear-gradient(135deg,#1abc9c,#148f77)" },
  { num: "35", initials: "LM", name: "Lucas Morel", pts: 1, split: "Split 2 Bs Aires", avatarGradient: "linear-gradient(135deg,#aab7b8,#717d7e)" },
