...
export const standings: StandingsRow[] = [
  { pos: 1, name: "Damian Ludueña", f1s1: "—", f1s2: "25", f2s1: "—", f2s2: "19", total: 44 },
  { pos: 2, name: "Franco Perez", f1s1: "—", f1s2: "19", f2s1: "17", f2s2: "—", total: 36 },
  { pos: 3, name: "Santino Casciano", f1s1: "13", f1s2: "—", f2s1: "22", f2s2: "—", total: 35 },
  { pos: 4, name: "Fabian Gamero", f1s1: "25", f1s2: "—", f2s1: "9", f2s2: "—", total: 34 },
  { pos: 5, name: "Julian Varlas", f1s1: "—", f1s2: "17", f2s1: "15", f2s2: "—", total: 32 },
  { pos: 6, name: "Alejandro Rodriguez", f1s1: "—", f1s2: "—", f2s1: "—", f2s2: "25", total: 25, status: "SUSPENDIDO" },
  { pos: 7, name: "Bruno Koller", f1s1: "—", f1s2: "—", f2s1: "25", f2s2: "—", total: 25 },
  { pos: 8, name: "Marcos Turri", f1s1: "22", f1s2: "—", f2s1: "1", f2s2: "—", total: 23 },
  { pos: 9, name: "Agustin Carreras", f1s1: "5", f1s2: "—", f2s1: "—", f2s2: "17", total: 22 },
  { pos: 10, name: "Joaquin Gutierrez", f1s1: "—", f1s2: "—", f2s1: "—", f2s2: "22", total: 22 },
  { pos: 11, name: "Brian Campos", f1s1: "—", f1s2: "22", f2s1: "—", f2s2: "—", total: 22 },
  { pos: 12, name: "Matteo Viñas", f1s1: "1", f1s2: "—", f2s1: "19", f2s2: "—", total: 20 },
  { pos: 13, name: "Bernardo Morico", f1s1: "19", f1s2: "—", f2s1: "—", f2s2: "—", total: 19 },
  { pos: 14, name: "Agustin Rojas", f1s1: "15", f1s2: "—", f2s1: "—", f2s2: "3", total: 18 },
  { pos: 15, name: "Nacho Davin", f1s1: "17", f1s2: "—", f2s1: "—", f2s2: "—", total: 17 },
  { pos: 16, name: "Matias Pacheco", f1s1: "—", f1s2: "5", f2s1: "—", f2s2: "11", total: 16 },
  { pos: 17, name: "Agustin Moles", f1s1: "—", f1s2: "—", f2s1: "—", f2s2: "15", total: 15 },
  { pos: 18, name: "Fernando Ali", f1s1: "—", f1s2: "15", f2s1: "—", f2s2: "—", total: 15 },
  { pos: 19, name: "Franco Guerreros", f1s1: "—", f1s2: "9", f2s1: "—", f2s2: "5", total: 14 },
  { pos: 20, name: "Kevin Lhuillier", f1s1: "—", f1s2: "13", f2s1: "—", f2s2: "—", total: 13 },
  { pos: 21, name: "Gonzalo Alonso", f1s1: "—", f1s2: "—", f2s1: "13", f2s2: "—", total: 13 },
  { pos: 22, name: "Uriel Manzanelli", f1s1: "—", f1s2: "—", f2s1: "—", f2s2: "13", total: 13 },
  { pos: 23, name: "Lucio Focaccia", f1s1: "—", f1s2: "11", f2s1: "—", f2s2: "—", total: 11 },
  { pos: 24, name: "Juan Jose Sanchez", f1s1: "11", f1s2: "—", f2s1: "—", f2s2: "—", total: 11 },
  { pos: 25, name: "Agustin Chijanoski", f1s1: "—", f1s2: "—", f2s1: "11", f2s2: "—", total: 11 },
  { pos: 26, name: "Agustin Savone", f1s1: "3", f1s2: "—", f2s1: "7", f2s2: "—", total: 10 },
  { pos: 27, name: "Patricio Aguerreche", f1s1: "9", f1s2: "—", f2s1: "—", f2s2: "—", total: 9 },
  { pos: 28, name: "Matias Cayrus Riffel", f1s1: "—", f1s2: "—", f2s1: "—", f2s2: "9", total: 9 },
  { pos: 29, name: "Nico Valero", f1s1: "—", f1s2: "1", f2s1: "—", f2s2: "7", total: 8 },
  { pos: 30, name: "Lucas Nin", f1s1: "—", f1s2: "7", f2s1: "—", f2s2: "—", total: 7 },
  { pos: 31, name: "Julian Valiñas", f1s1: "7", f1s2: "—", f2s1: "—", f2s2: "—", total: 7 },
  { pos: 32, name: "Eric Priemer", f1s1: "—", f1s2: "—", f2s1: "5", f2s2: "—", total: 5 },
  { pos: 33, name: "Luka Sanchez", f1s1: "—", f1s2: "3", f2s1: "—", f2s2: "—", total: 3 },
  { pos: 34, name: "Santiago Ortiz Ocampo", f1s1: "—", f1s2: "—", f2s1: "3", f2s2: "—", total: 3 },
  { pos: 35, name: "Lucas Morel", f1s1: "—", f1s2: "—", f2s1: "—", f2s2: "1", total: 1 },
